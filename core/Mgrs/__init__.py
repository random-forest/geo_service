...
"""
UTM zones are grouped, and assigned to one of a group of 6 ets.
"""
NUM_100K_SETS = 6
...
def LLtoUTM(lat, lon):
  ...
  return {
    'northing': int(math.floor(UTMNorthing + 0.5)),
    'easting': int(math.floor(UTMEasting + 0.5)),
...
"""
Given the first letter from a two-letter MGRS 100k zone, 
and given the MGRS table set for the zone number, 
figure out the easting value that should be added to the other, 
secondary easting value.
"""
